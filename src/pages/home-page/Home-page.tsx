  ...
  return (
    <div className="homepage" id="home">
      ...
      <section id="section" className="about-section">
        ...
        <div className="text-section">
          <motion.div
            initial={{ x: "100%", opacity: 0 }} // Use relative units instead of 100vw
          ...
          >
            ...
            <div className="_sub_title">
              ...
              <p>
                ...
                product for an S&P 500 company, where I learned the importance
                of clean architecture, accountability, and delivering value
                under high standards. I’ve worked on both new, innovative
                projects and the improvement of legacy systems — both equally
              ...
              <p>
                ...
                working across the full stack and bridging the gap between
                systems and user experience. I hold a Bachelor’s degree in
                Business Information Systems, giving me a strong foundation in
                both technology and business strategy.
              </p>
              <p>
                I believe that great software is built where technical
                excellence meets real-world value. I’m easygoing,
                growth-oriented, and driven by curiosity. I'm always eager to
                learn, improve, and contribute to meaningful, sustainable, and
                future-ready digital products. Thanks for visiting — I’d love
                the opportunity to help drive your team’s success.
              </p>
            </div>
